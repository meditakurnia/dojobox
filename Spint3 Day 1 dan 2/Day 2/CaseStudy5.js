...
//tidak pakai nilai balik
//segi empat (sisi*sisi)
// segipanjang (p*l)

//menggunakan nilai balik
//segitiga (0.5*alas*tinggi)
//lingkaran (3.14*jarijari^2)


//fungsi menghitung keliling dengan function expression
//segiempat (4*sisi)
// segipanjang (2*(panjang+lebar))

// var nilaiInput1 = parseInt(prompt("Masukan sisi bangun datar : "));
...
function tampilKelilingLingkaran(){
    ...
    var keliling = hitungKelilingLingkaran(jari)
